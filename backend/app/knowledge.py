...
RULE_DEFINITIONS = [
    ...
    {
        "id": "bullish_wedge_reversal",
        "name": "三推楔形底反转",
        "category": "reversal",
        "description": "下跌中出现三次向下推动且动能收缩，第三推后以强势反转 K 线确认。",
        "direction": "long",
        "parameters": {"lookback": 30, "contraction_ratio": 0.9, "close_location": 0.65},
        "source_references": [
            source_reference(
                "course_slides_5414",
                "视频教程的 课件幻灯片.pdf",
    ...
    {
        "id": "double_bottom_reversal",
        "name": "双底结构反转",
        "category": "reversal",
        "description": "两次测试相近支撑，第二次测试未有效跌破并以强势收盘确认。",
        "direction": "long",
        "parameters": {"lookback": 35, "minimum_separation": 5, "tolerance_atr": 0.5},
        "source_references": [
            source_reference(
                "course_slides_5414",
                "视频教程的 课件幻灯片.pdf",
            ...
            source_reference(
                ...
                [183, 265],
                "printed",
                "第12章双重顶底牛旗；第20章双重顶底反转",
                "双底既可能是交易区间形态，也可能成为趋势反转",
            ),
            source_reference(
                "trading_price_action_reversals_1",
                "高级反转技术分析 价格行为交易系统之反转分析 上(高清).pdf",
                ...
                "printed",
                "第8章：双重顶和双重底的回调",
                "第二次低点测试与反转 K 线共同定义交易触发",
            ),
        ],
    },
    {
        "id": "second_entry_long",
        "name": "二次入场做多（H2）",
        "category": "trend",
        "description": "上升趋势回调中第二次向上突破尝试，要求趋势仍有效且触发 K 线强势。",
        "direction": "long",
        "parameters": {"lookback": 14, "minimum_rr": 2.0},
        "source_references": [
            source_reference(
                "course_slides_5414",
                "视频教程的 课件幻灯片.pdf",
            ...
            source_reference(
                ...
                "printed",
                "第17章：高1、高2、高3、高4形态",
                "H2 是第二次向上突破前一根 K 线高点的尝试",
            ),
        ],
    },
    {
        "id": "micro_channel_pullback",
        "name": "微型通道首次回调",
        "category": "trend",
        "description": "连续抬高低点形成多头微型通道，首次浅回调后重新突破前一日高点。",
        "direction": "long",
        "parameters": {"channel_bars": 5, "pullback_atr": 0.8, "minimum_rr": 2.0},
        "source_references": [
            source_reference(
                "course_slides_5414",
                "视频教程的 课件幻灯片.pdf",
